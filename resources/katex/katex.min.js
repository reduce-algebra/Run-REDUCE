!(function (e, t) {
  ...
  return (function () {
    ...
    var Oe = Ie,
      ...
      He = function (e) {
        return (
          "string" != typeof e && (e = e.unit), e in Re || e in Ee || "ex" === e
        );
      },
      Le = function (e, t) {
        var r;
      ...
      Pe = function (e, t, r, n, a) {
        ...
        if (((e = o.value), s)) {
          ...
          ("text" === r || (n && "mathit" === n.font)) && (l = 0),
            (i = new O(e, s.height, s.depth, l, s.skew, s.width, a));
        } else
          "undefined" != typeof console &&
            console.warn(
    ...
    var It = function (e) {
      ...
      Dt = function (e) {
        var t = new Mt.MathNode("mo", [new Mt.TextNode(Et[e])]);
    ...
    function Dr(e, t, r) {
      ...
      if (
        ...
        if (null == p) s = 1;
        else if (!(s = parseFloat(p)) || s < 0)
          throw new n("Invalid \\arraystretch: " + p);
      }
      e.gullet.beginGroup();
      var d = [],
        f = [d],
      ...
      for (v.push(Hr(e)); ; ) {
        ...
        if ("&" === y) {
          ...
          e.consume();
          var x = void 0;
          " " !== e.gullet.future().text && (x = e.parseSizeGroup(!0)),
            g.push(x ? x.value : null),
            v.push(Hr(e)),
            (d = []),
            f.push(d);
        }
    ...
    var Fr = function (e, t) {
        ...
        if (e.addEqnNum)
          for (r = 0; r < i; ++r) {
            ...
            (L.depth = E.depth),
              (L.height = E.height),
              R.push({ type: "elem", elem: L, shift: H });
          }
    ...
    var sn = function (e, t, r, n, a, i, o) {
      ...
      hn = function (e, t) {
        ...
        var v = 0,
          y = 0;
        return (
          (o instanceof O || "\\oiint" === a.name || "\\oiiint" === a.name) &&
            !a.suppressBaseShift &&
    ...
    at({
      ...
      htmlBuilder: function (e, t) {
        ...
        if (yn.hasOwnProperty(e.text))
          return je.makeSpan(["mspace", yn[e.text]], [], t);
        throw new n('Unknown type of space "' + e.text + '"');
      },
      mathmlBuilder: function (e, t) {
        if (!xn.hasOwnProperty(e.text)) {
          if (yn.hasOwnProperty(e.text)) return new Mt.MathNode("mspace");
          throw new n('Unknown type of space "' + e.text + '"');
        }
    ...
    var kn = {
      ...
      zn = function (e, t) {
        ...
        return r
          ? kn[r]
            ? t.withTextFontFamily(kn[r])
            : Sn[r]
            ? t.withTextFontWeight(Sn[r])
            : t.withTextFontShape(Mn[r])
          : t;
      };
    nt({
      type: "text",
      ...
      nt({
        ...
        htmlBuilder: function (e, t) {
          for (
            var r = An(e), n = [], a = t.havingStyle(t.style.text()), i = 0;
            i < r.length;
            i++
          ) {
            var o = r[i];
      ...
      qn = (function () {
        ...
        return (
          (e.prototype.range = function (t, r) {
            return new e(r, Bn.range(this, t));
          }),
          e
        );
      })(),
      ...
      In = (function () {
        ...
        return (
          ...
          (t.lex = function () {
            ...
            return (
              o && (a = o[1]),
              new qn(a, new Bn(this, t, this.tokenRegex.lastIndex))
            );
          }),
          e
        );
    ...
    Hn("\\noexpand", function (e) {
      ...
      Hn("\\@ifstar", "\\@ifnextchar *{\\@firstoftwo{#1}}"),
      Hn("\\TextOrMath", function (e) {
    ...
    Hn("\\char", function (e) {
      ...
      if (t) {
        if (null == (a = Ln[r.text]) || a >= t)
          throw new n("Invalid base-" + t + " digit " + r.text);
        for (var i; null != (i = Ln[e.future().text]) && i < t; )
          (a *= t), (a += i), e.popToken();
      }
      return "\\@char{" + a + "}";
    });
    ...
    Hn("\\newcommand", function (e) {
      ...
      Hn("\\renewcommand", function (e) {
        return Dn(e, !0, !1);
      }),
      Hn("\\providecommand", function (e) {
        return Dn(e, !0, !0);
      }),
      Hn("\\message", function (e) {
      ...
      Hn("\\aa", "\\r a"),
      Hn("\\AA", "\\r A"),
      Hn("\\textcopyright", "\\html@mathml{\\textcircled{c}}{\\char`\xa9}"),
      Hn(
        "\\copyright",
      ...
      Hn("\\Bbbk", "\\Bbb{k}"),
      Hn("\xb7", "\\cdotp"),
      Hn("\\llap", "\\mathllap{\\textrm{#1}}"),
      Hn("\\rlap", "\\mathrlap{\\textrm{#1}}"),
      Hn("\\clap", "\\mathclap{\\textrm{#1}}"),
      Hn("\\mathstrut", "\\vphantom{(}"),
      Hn("\\underbar", "\\underline{\\text{#1}}"),
      ...
      Hn("\u231f", "\\lrcorner"),
      Hn("\xa9", "\\copyright"),
      Hn("\xae", "\\textregistered"),
      Hn("\ufe0f", "\\textregistered"),
      Hn("\\ulcorner", '\\html@mathml{\\@ulcorner}{\\mathop{\\char"231c}}'),
      Hn("\\urcorner", '\\html@mathml{\\@urcorner}{\\mathop{\\char"231d}}'),
      Hn("\\llcorner", '\\html@mathml{\\@llcorner}{\\mathop{\\char"231e}}'),
      Hn("\\lrcorner", '\\html@mathml{\\@lrcorner}{\\mathop{\\char"231f}}'),
      Hn("\\vdots", "\\mathord{\\varvdots\\rule{0pt}{15pt}}"),
      Hn("\u22ee", "\\vdots"),
      Hn("\\varGamma", "\\mathit{\\Gamma}"),
      Hn("\\varDelta", "\\mathit{\\Delta}"),
      Hn("\\varTheta", "\\mathit{\\Theta}"),
      Hn("\\varLambda", "\\mathit{\\Lambda}"),
      Hn("\\varXi", "\\mathit{\\Xi}"),
      Hn("\\varPi", "\\mathit{\\Pi}"),
      Hn("\\varSigma", "\\mathit{\\Sigma}"),
      Hn("\\varUpsilon", "\\mathit{\\Upsilon}"),
      Hn("\\varPhi", "\\mathit{\\Phi}"),
      Hn("\\varPsi", "\\mathit{\\Psi}"),
      Hn("\\varOmega", "\\mathit{\\Omega}"),
      Hn("\\substack", "\\begin{subarray}{c}#1\\end{subarray}"),
      Hn(
        "\\colon",
        "\\nobreak\\mskip2mu\\mathpunct{}\\mathchoice{\\mkern-3mu}{\\mkern-3mu}{}{}{:}\\mskip6mu"
      ),
      Hn("\\boxed", "\\fbox{$\\displaystyle{#1}$}"),
      Hn("\\iff", "\\DOTSB\\;\\Longleftrightarrow\\;"),
      Hn("\\implies", "\\DOTSB\\;\\Longrightarrow\\;"),
      Hn("\\impliedby", "\\DOTSB\\;\\Longleftarrow\\;");
    var Pn = {
      ",": "\\dotsc",
      "\\not": "\\dotsb",
      "+": "\\dotsb",
    ...
    Hn("\\dotso", function (e) {
      return e.future().text in Fn ? "\\ldots\\," : "\\ldots";
    }),
      Hn("\\dotsc", function (e) {
        var t = e.future().text;
        return t in Fn && "," !== t ? "\\ldots\\," : "\\ldots";
      }),
      Hn("\\cdots", function (e) {
        return e.future().text in Fn ? "\\@cdots\\," : "\\@cdots";
      }),
      Hn("\\dotsb", "\\cdots"),
      Hn("\\dotsm", "\\cdots"),
      Hn("\\dotsi", "\\!\\cdots"),
      ...
      Hn("\\DOTSB", "\\relax"),
      Hn("\\DOTSX", "\\relax"),
      Hn("\\tmspace", "\\TextOrMath{\\kern#1#3}{\\mskip#1#2}\\relax"),
      Hn("\\,", "\\tmspace+{3mu}{.1667em}"),
      Hn("\\thinspace", "\\,"),
      Hn("\\>", "\\mskip{4mu}"),
      Hn("\\:", "\\tmspace+{4mu}{.2222em}"),
      Hn("\\medspace", "\\:"),
      Hn("\\;", "\\tmspace+{5mu}{.2777em}"),
      Hn("\\thickspace", "\\;"),
      Hn("\\!", "\\tmspace-{3mu}{.1667em}"),
      Hn("\\negthinspace", "\\!"),
      ...
      Hn("\\enspace", "\\kern.5em "),
      Hn("\\enskip", "\\hskip.5em\\relax"),
      Hn("\\quad", "\\hskip1em\\relax"),
      Hn("\\qquad", "\\hskip2em\\relax"),
      Hn("\\tag", "\\@ifstar\\tag@literal\\tag@paren"),
      Hn("\\tag@paren", "\\tag@literal{({#1})}"),
      Hn("\\tag@literal", function (e) {
    ...
    Hn(
      ...
      Hn("\\hspace", "\\@ifstar\\@hspacer\\@hspace"),
      Hn("\\@hspace", "\\hskip #1\\relax"),
      Hn("\\@hspacer", "\\rule{0pt}{0pt}\\hskip #1\\relax"),
      Hn("\\ordinarycolon", ":"),
      Hn("\\vcentcolon", "\\mathrel{\\mathop\\ordinarycolon}"),
      Hn(
        "\\dblcolon",
      ...
      Hn("\u2a74", "\\Coloneqq"),
      Hn("\\ratio", "\\vcentcolon"),
      Hn("\\coloncolon", "\\dblcolon"),
      Hn("\\colonequals", "\\coloneqq"),
      Hn("\\coloncolonequals", "\\Coloneqq"),
      Hn("\\equalscolon", "\\eqqcolon"),
      Hn("\\equalscoloncolon", "\\Eqqcolon"),
      Hn("\\colonminus", "\\coloneq"),
      Hn("\\coloncolonminus", "\\Coloneq"),
      Hn("\\minuscolon", "\\eqcolon"),
      Hn("\\minuscoloncolon", "\\Eqcolon"),
      Hn("\\coloncolonapprox", "\\Colonapprox"),
      Hn("\\coloncolonsim", "\\Colonsim"),
      Hn("\\simcolon", "\\mathrel{\\sim\\mathrel{\\mkern-1.2mu}\\vcentcolon}"),
      Hn(
        "\\simcoloncolon",
      ...
      Hn("\\notni", "\\html@mathml{\\not\\ni}{\\mathrel{\\char`\u220c}}"),
      Hn("\\limsup", "\\DOTSB\\operatorname*{lim\\,sup}"),
      Hn("\\liminf", "\\DOTSB\\operatorname*{lim\\,inf}"),
      Hn("\\injlim", "\\DOTSB\\operatorname*{inj\\,lim}"),
      Hn("\\projlim", "\\DOTSB\\operatorname*{proj\\,lim}"),
      Hn("\\varlimsup", "\\DOTSB\\operatorname*{\\overline{lim}}"),
      Hn("\\varliminf", "\\DOTSB\\operatorname*{\\underline{lim}}"),
      Hn("\\varinjlim", "\\DOTSB\\operatorname*{\\underrightarrow{lim}}"),
      Hn("\\varprojlim", "\\DOTSB\\operatorname*{\\underleftarrow{lim}}"),
      Hn("\\gvertneqq", "\\html@mathml{\\@gvertneqq}{\u2269}"),
      Hn("\\lvertneqq", "\\html@mathml{\\@lvertneqq}{\u2268}"),
      ...
      Hn("\\varsubsetneq", "\\html@mathml{\\@varsubsetneq}{\u228a}"),
      Hn("\\varsubsetneqq", "\\html@mathml{\\@varsubsetneqq}{\u2acb}"),
      Hn("\\varsupsetneq", "\\html@mathml{\\@varsupsetneq}{\u228b}"),
      Hn("\\varsupsetneqq", "\\html@mathml{\\@varsupsetneqq}{\u2acc}"),
      Hn("\\imath", "\\html@mathml{\\@imath}{\u0131}"),
      Hn("\\jmath", "\\html@mathml{\\@jmath}{\u0237}"),
      Hn(
        "\\llbracket",
      ...
      Hn("\\Complex", "\\mathbb{C}"),
      Hn("\\Dagger", "\\ddagger"),
      Hn("\\diamonds", "\\diamondsuit"),
      Hn("\\empty", "\\emptyset"),
      Hn("\\Epsilon", "\\mathrm{E}"),
      Hn("\\Eta", "\\mathrm{H}"),
      Hn("\\exist", "\\exists"),
      Hn("\\harr", "\\leftrightarrow"),
      Hn("\\hArr", "\\Leftrightarrow"),
      Hn("\\Harr", "\\Leftrightarrow"),
      Hn("\\hearts", "\\heartsuit"),
      Hn("\\image", "\\Im"),
      ...
      Hn("\\weierp", "\\wp"),
      Hn("\\Zeta", "\\mathrm{Z}"),
      Hn("\\argmin", "\\DOTSB\\operatorname*{arg\\,min}"),
      Hn("\\argmax", "\\DOTSB\\operatorname*{arg\\,max}"),
      Hn("\\plim", "\\DOTSB\\mathop{\\operatorname{plim}}\\limits"),
      Hn("\\bra", "\\mathinner{\\langle{#1}|}"),
      Hn("\\ket", "\\mathinner{|{#1}\\rangle}"),
      Hn("\\braket", "\\mathinner{\\langle{#1}\\rangle}"),
      Hn("\\Bra", "\\left\\langle#1\\right|"),
      Hn("\\Ket", "\\left|#1\\right\\rangle"),
      Hn("\\angln", "{\\angl n}"),
      Hn("\\blue", "\\textcolor{##6495ed}{#1}"),
      Hn("\\orange", "\\textcolor{##ffa500}{#1}"),
      Hn("\\pink", "\\textcolor{##ff00af}{#1}"),
      Hn("\\red", "\\textcolor{##df0030}{#1}"),
      Hn("\\green", "\\textcolor{##28ae7b}{#1}"),
      Hn("\\gray", "\\textcolor{gray}{#1}"),
      Hn("\\purple", "\\textcolor{##9d38bd}{#1}"),
      Hn("\\blueA", "\\textcolor{##ccfaff}{#1}"),
      Hn("\\blueB", "\\textcolor{##80f6ff}{#1}"),
      Hn("\\blueC", "\\textcolor{##63d9ea}{#1}"),
      Hn("\\blueD", "\\textcolor{##11accd}{#1}"),
      Hn("\\blueE", "\\textcolor{##0c7f99}{#1}"),
      Hn("\\tealA", "\\textcolor{##94fff5}{#1}"),
      Hn("\\tealB", "\\textcolor{##26edd5}{#1}"),
      Hn("\\tealC", "\\textcolor{##01d1c1}{#1}"),
      Hn("\\tealD", "\\textcolor{##01a995}{#1}"),
      Hn("\\tealE", "\\textcolor{##208170}{#1}"),
      Hn("\\greenA", "\\textcolor{##b6ffb0}{#1}"),
      Hn("\\greenB", "\\textcolor{##8af281}{#1}"),
      Hn("\\greenC", "\\textcolor{##74cf70}{#1}"),
      Hn("\\greenD", "\\textcolor{##1fab54}{#1}"),
      Hn("\\greenE", "\\textcolor{##0d923f}{#1}"),
      Hn("\\goldA", "\\textcolor{##ffd0a9}{#1}"),
      Hn("\\goldB", "\\textcolor{##ffbb71}{#1}"),
      Hn("\\goldC", "\\textcolor{##ff9c39}{#1}"),
      Hn("\\goldD", "\\textcolor{##e07d10}{#1}"),
      Hn("\\goldE", "\\textcolor{##a75a05}{#1}"),
      Hn("\\redA", "\\textcolor{##fca9a9}{#1}"),
      Hn("\\redB", "\\textcolor{##ff8482}{#1}"),
      Hn("\\redC", "\\textcolor{##f9685d}{#1}"),
      Hn("\\redD", "\\textcolor{##e84d39}{#1}"),
      Hn("\\redE", "\\textcolor{##bc2612}{#1}"),
      Hn("\\maroonA", "\\textcolor{##ffbde0}{#1}"),
      Hn("\\maroonB", "\\textcolor{##ff92c6}{#1}"),
      Hn("\\maroonC", "\\textcolor{##ed5fa6}{#1}"),
      Hn("\\maroonD", "\\textcolor{##ca337c}{#1}"),
      Hn("\\maroonE", "\\textcolor{##9e034e}{#1}"),
      Hn("\\purpleA", "\\textcolor{##ddd7ff}{#1}"),
      Hn("\\purpleB", "\\textcolor{##c6b9fc}{#1}"),
      Hn("\\purpleC", "\\textcolor{##aa87ff}{#1}"),
      Hn("\\purpleD", "\\textcolor{##7854ab}{#1}"),
      Hn("\\purpleE", "\\textcolor{##543b78}{#1}"),
      Hn("\\mintA", "\\textcolor{##f5f9e8}{#1}"),
      Hn("\\mintB", "\\textcolor{##edf2df}{#1}"),
      Hn("\\mintC", "\\textcolor{##e0e5cc}{#1}"),
      Hn("\\grayA", "\\textcolor{##f6f7f7}{#1}"),
      Hn("\\grayB", "\\textcolor{##f0f1f2}{#1}"),
      Hn("\\grayC", "\\textcolor{##e3e5e6}{#1}"),
      Hn("\\grayD", "\\textcolor{##d6d8da}{#1}"),
      Hn("\\grayE", "\\textcolor{##babec2}{#1}"),
      Hn("\\grayF", "\\textcolor{##888d93}{#1}"),
      Hn("\\grayG", "\\textcolor{##626569}{#1}"),
      Hn("\\grayH", "\\textcolor{##3b3e40}{#1}"),
      Hn("\\grayI", "\\textcolor{##21242c}{#1}"),
      Hn("\\kaBlue", "\\textcolor{##314453}{#1}"),
      Hn("\\kaGreen", "\\textcolor{##71B307}{#1}");
    var Gn = {
        "\\relax": !0,
        "^": !0,
        _: !0,
            ...
            if ("string" == typeof r) {
              ...
              if (-1 !== r.indexOf("#"))
                for (
                  ...
                  ++n;
              for (
                var i = new In(r, this.settings), o = [], s = i.lex();
                "EOF" !== s.text;
          ...
          (t.isExpandable = function (e) {
            ...
            return null != t
              ? "string" == typeof t ||
                  "function" == typeof t ||
                  !t.unexpandable
              : Tn.hasOwnProperty(e) && !Tn[e].primitive;
          }),
          e
        );
      })(),
      ...
      Xn = (function () {
        function e(e, t) {
          (this.mode = void 0),
            ...
            (this.mode = "math"),
            (this.gullet = new Un(e, t, this.mode)),
            (this.settings = t),
        ...
        return (
          ...
          (t.parseExpression = function (t, r) {
            for (var n = []; ; ) {
              ...
              if (r && a.text === r) break;
              if (t && Tn[a.text] && Tn[a.text].infix) break;
    ...
    var $n = function (e, t, r) {
        ...
        var a = je.makeSpan(["katex-error"], [new O(t)]);
        return (
